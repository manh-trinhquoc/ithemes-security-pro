...
class ITSEC_WordPress_Tweaks_Validator extends ITSEC_Validator {
	...
	protected function sanitize_settings() {
		...
		$this->sanitize_setting( array( 'both', 'email', 'username' ), 'valid_user_login_type', __( 'Login with Email Address or Username', 'it-l10n-ithemes-security-pro' ) );
		$this->sanitize_setting( 'bool', 'patch_thumb_file_traversal', __( 'Mitigate Attachment File Traversal Attack', 'it-l10n-ithemes-security-pro' ) );
	}
