...
?>
	...
	<div class="itsec-warning-message"><?php printf( __( '<span>WARNING: </span><a href="%1$s" data-module-link="backup">Backup your database</a> before using this tool.', 'it-l10n-ithemes-security-pro' ), ITSEC_Core::get_backup_creation_page_url() ); ?></div>
<?php
