...
final class ITSEC_Hide_Backend_Privacy {
	...
	public function get_privacy_policy_for_cookies( $policy ) {
		...
		$policy .= "<p>$suggested_text " . esc_html__( 'Visiting the login page sets a temporary cookie that aids compatibility with some alternate login methods. This cookie contains no personal data and expires after 1 hour.', 'it-l10n-ithemes-security-pro' ) . "</p>\n";
