...
class Matchables extends \WP_REST_Controller {
	...
	public function get_items_permissions_check( $request ) {
		if ( ! current_user_can( 'itsec_list_user_groups' ) ) {
			return new \WP_Error( 'rest_cannot_view', __( 'Sorry, you are not allowed to list user matchables.', 'it-l10n-ithemes-security-pro' ), [ 'status' => rest_authorization_required_code() ] );
		}
