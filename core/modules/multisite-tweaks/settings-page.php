	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<p class="description"><?php _e( 'Hides theme update notifications from users who cannot update themes.', 'it-l10n-ithemes-security-pro' ); ?></p>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<p class="description"><?php _e( 'Hides plugin update notifications from users who cannot update plugins.', 'it-l10n-ithemes-security-pro' ); ?></p>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<p class="description"><?php _e( 'Hides core update notifications from users who cannot update core.', 'it-l10n-ithemes-security-pro' ); ?></p>
			</td>
		</tr>
	</table>
<?php
