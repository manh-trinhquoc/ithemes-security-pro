			...
			<?php if ( ! ITSEC_Modules::is_active( 'security-check-pro' ) ) : ?>
				<p>
					<label>
						...
						<?php printf(
							esc_html__( 'Enable Security Check Pro to identify IP addresses and ensure attackers are locked out correctly. This requires contacting an iThemes.com server. Read our %1$sPrivacy Policy%2$s.', 'it-l10n-ithemes-security-pro' ),
