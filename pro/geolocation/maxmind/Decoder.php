...
class ITSEC_MaxMind_DB_Decoder
{
    private $fileStream;
    private $pointerBase;
    ...
    public function decode($offset)
    {
        list(, $ctrlByte) = unpack(
            'C',
            ITSEC_MaxMind_DB_Util::read($this->fileStream, $offset, 1)
        );
        $offset++;
    ...
    private function decodeByType($type, $offset, $size)
    {
        ...
        $bytes = ITSEC_MaxMind_DB_Util::read($this->fileStream, $offset, $size);
        switch ($type) {
            case 'utf8_string':
    ...
    private function decodePointer($ctrlByte, $offset)
    {
        ...
        $buffer = ITSEC_MaxMind_DB_Util::read($this->fileStream, $offset, $pointerSize);
    ...
    private function sizeFromCtrlByte($ctrlByte, $offset)
    {
        ...
        $bytes = ITSEC_MaxMind_DB_Util::read($this->fileStream, $offset, $bytesToRead);
